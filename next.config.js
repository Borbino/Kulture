...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'pbs.twimg.com', // Twitter 이미지
      },
      {
        protocol: 'https',
        hostname: 'external-preview.redd.it', // Reddit 썸네일
      },
      {
        protocol: 'https',
        hostname: 'preview.redd.it', // Reddit 이미지
      },
    ],
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://www.google-analytics.com https://api.sanity.io wss:",
