...
// ══════════════════════════════════════════════════════
// ⛔ 절대 차단 시그널 (크롤링/컨텐츠 생성 모두 금지)
// 페미니즘과 조금이라도 관련된 모든 키워드를 차단합니다.
// ══════════════════════════════════════════════════════
export const BLOCKED_SIGNALS = [
  // 영어
  'feminism', 'feminist', 'feminists', 'anti-feminism',
  'gender equality activism', 'gender politics', 'gender wage gap',
  'gender inequality', 'gender discrimination',
  'metoo', 'me too', 'me too movement', '#metoo',
  'womens rights activist', 'women rights movement', 'womens liberation',
  'patriarchy', 'rape culture', 'toxic masculinity',
  'mansplaining', 'misogyny', 'misogynist', 'sexism',
  'incel', 'red pill feminism', 'fourth wave feminism',
  // 한국어
  '페미니즘', '페미니스트', '페미', '꼴페미', '한남충',
  '여성혐오', '남성혐오', '젠더갈등', '젠더이슈',
  '성차별', '미투', '미투운동', '#미투',
  '여성운동', '여권신장', '가부장제',
  // 관련 운동/조직명
  'ewha feminist', 'radical feminist', 'gender activist',
  'intersectional feminism', 'eco-feminism',
];

/**
 * 차단 대상 콘텐츠 여부 확인
 * @param {string} text
 * @returns {boolean} true = 차단해야 함
 */
