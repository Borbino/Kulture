...
export async function collectAllTrends() {
  ...
  const [googleTrends, naverTrends, twitterTrends, youtubeTrends, redditTrends] = await Promise.all(
    [
      fetchGoogleTrends(),
  ...
  console.log(`[Trend Collection] Collected ${allTrends.length} raw trends from ${5} sources`)
