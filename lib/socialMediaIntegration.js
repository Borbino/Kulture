 ...
 */
async function fetchInstagramData(username, options = {}) {
  try {
 ...
 */
async function fetchTikTokData(username, options = {}) {
  try {
 ...
 */
async function fetchFacebookData(pageId, options = {}) {
  try {
 ...
 * API: Weibo Open API
 */
async function fetchWeiboData(userId, options = {}) {
  try {
 ...
 */
async function fetchXiaohongshuData(keyword, options = {}) {
  try {
 ...
 */
async function fetchBilibiliData(keyword, options = {}) {
  try {
