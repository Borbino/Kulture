...
Response Format: JSON object with keys "content" (string) and "pollData" (object with "question" (string) and "options" (array of 2 strings)).`;
...
Please write in a way that both educates and entertains readers. Return the result strictly as a valid JSON object.`;
    ...
    const pollData = resultJson.pollData;
